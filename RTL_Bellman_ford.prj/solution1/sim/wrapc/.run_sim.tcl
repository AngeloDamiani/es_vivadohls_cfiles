...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bellman_ford.autotvin.dat"
	set constFileTvOut       "bellman_ford.autotvout.dat"
	set constFileHdlTvIn     "bellman_ford.autohdltvin.dat"
	set constFileHdlTvOut    "bellman_ford.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
