...
if {[file isfile insertion_sort.autotvin.dat]} {
	file delete -force insertion_sort.autotvin.dat
}

if {[file isfile insertion_sort.autotvout.dat]} {
	file delete -force insertion_sort.autotvout.dat
}
