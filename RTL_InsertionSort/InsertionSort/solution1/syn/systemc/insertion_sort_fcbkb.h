...
#ifndef __insertion_sort_fcbkb__HH__
#define __insertion_sort_fcbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(insertion_sort_fcbkb) {
    ...
    SC_CTOR(insertion_sort_fcbkb):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
