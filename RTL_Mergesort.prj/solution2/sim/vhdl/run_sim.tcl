...
if {[file isfile mergesort.autotvin.dat]} {
	file delete -force mergesort.autotvin.dat
}

if {[file isfile mergesort.autotvout.dat]} {
	file delete -force mergesort.autotvout.dat
}
