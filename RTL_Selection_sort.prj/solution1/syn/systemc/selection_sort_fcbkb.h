...
#ifndef __selection_sort_fcbkb__HH__
#define __selection_sort_fcbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(selection_sort_fcbkb) {
    ...
    SC_CTOR(selection_sort_fcbkb):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
