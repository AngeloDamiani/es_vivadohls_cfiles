set C_TypeInfoList {{ 
"selection_sort" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"arr": [[], {"array": [ {"scalar": "float"}, [10]]}] }],[],""]
}}
set moduleName selection_sort
...
set C_modelName {selection_sort}
set C_modelType { void 0 }
set C_modelArgList {
	{ arr float 32 regular {array 10 { 2 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "arr", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "arr","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 9,"step" : 1}]}]}]} ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.selection_sort_fcbkb_U1", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "73", "Max" : "361"}
	, {"Name" : "Interval", "Min" : "74", "Max" : "362"}
]}
...
set Spec2ImplPortList { 
	arr { ap_memory {  { arr_address0 mem_address 1 4 }  { arr_ce0 mem_ce 1 1 }  { arr_we0 mem_we 1 1 }  { arr_d0 mem_din 1 32 }  { arr_q0 mem_dout 0 32 }  { arr_address1 mem_address 1 4 }  { arr_ce1 mem_ce 1 1 }  { arr_we1 mem_we 1 1 }  { arr_d1 mem_din 1 32 }  { arr_q1 mem_dout 0 32 } } }
}
