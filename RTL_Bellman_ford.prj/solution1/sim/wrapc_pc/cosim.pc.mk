...
$(ObjDir)/bellman_ford_test.c_pre.c.tb.o : bellman_ford_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) bellman_ford_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/bellman_ford.c_pre.c.tb.o : bellman_ford.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) bellman_ford.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
