...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mergesort.autotvin.dat"
	set constFileTvOut       "mergesort.autotvout.dat"
	set constFileHdlTvIn     "mergesort.autohdltvin.dat"
	set constFileHdlTvOut    "mergesort.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
