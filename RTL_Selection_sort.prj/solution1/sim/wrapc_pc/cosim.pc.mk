...
$(ObjDir)/selection_sort_test.c_pre.c.tb.o : selection_sort_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) selection_sort_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/selection_sort.c_pre.c.tb.o : selection_sort.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) selection_sort.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
