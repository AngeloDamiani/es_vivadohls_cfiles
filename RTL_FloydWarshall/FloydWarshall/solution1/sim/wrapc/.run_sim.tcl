...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "floyd_warshall.autotvin.dat"
	set constFileTvOut       "floyd_warshall.autotvout.dat"
	set constFileHdlTvIn     "floyd_warshall.autohdltvin.dat"
	set constFileHdlTvOut    "floyd_warshall.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
