...
#ifndef __gcd_fcmp_32ns_32ncud__HH__
#define __gcd_fcmp_32ns_32ncud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(gcd_fcmp_32ns_32ncud) {
    ...
    SC_CTOR(gcd_fcmp_32ns_32ncud):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
