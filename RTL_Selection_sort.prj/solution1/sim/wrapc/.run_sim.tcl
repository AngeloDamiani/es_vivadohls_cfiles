...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "selection_sort.autotvin.dat"
	set constFileTvOut       "selection_sort.autotvout.dat"
	set constFileHdlTvIn     "selection_sort.autohdltvin.dat"
	set constFileHdlTvOut    "selection_sort.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
