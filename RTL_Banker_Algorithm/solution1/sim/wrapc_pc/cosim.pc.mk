...
$(ObjDir)/banker_algorithm_test.c_pre.c.tb.o : banker_algorithm_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) banker_algorithm_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/banker_algorithm.c_pre.c.tb.o : banker_algorithm.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) banker_algorithm.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
