...
if {[file isfile selection_sort.autotvin.dat]} {
	file delete -force selection_sort.autotvin.dat
}

if {[file isfile selection_sort.autotvout.dat]} {
	file delete -force selection_sort.autotvout.dat
}
