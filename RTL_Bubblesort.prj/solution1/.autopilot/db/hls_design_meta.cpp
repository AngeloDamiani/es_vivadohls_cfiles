...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("arr_d0", 64, hls_out, 0, "ap_memory", "mem_din", 1),
	Port_Property("arr_q0", 64, hls_in, 0, "ap_memory", "mem_dout", 1),
	...
	Port_Property("arr_d1", 64, hls_out, 0, "ap_memory", "mem_din", 1),
	Port_Property("arr_q1", 64, hls_in, 0, "ap_memory", "mem_dout", 1),
};
