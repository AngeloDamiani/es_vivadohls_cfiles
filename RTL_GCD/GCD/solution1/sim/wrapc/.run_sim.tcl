...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gcd.autotvin.dat"
	set constFileTvOut       "gcd.autotvout.dat"
	set constFileHdlTvIn     "gcd.autohdltvin.dat"
	set constFileHdlTvOut    "gcd.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
