#pragma line 1 "/home/angelo/Desktop/SistemiEmbedded/VivadoHLSProject/ProjectFolder/RTL_mergesort.prj/solution1/mergesort_test.c"
...
#pragma line 2 "/home/angelo/Desktop/SistemiEmbedded/VivadoHLSProject/ProjectFolder/RTL_mergesort.prj/solution1/mergesort_test.c" 2
...
#pragma empty_line
#pragma line 3 "/home/angelo/Desktop/SistemiEmbedded/VivadoHLSProject/ProjectFolder/RTL_mergesort.prj/solution1/mergesort_test.c" 2
#pragma empty_line
int8_t h = 0;
#pragma empty_line
#pragma empty_line
void sw_merge(int8_t i1, long f1, long f2, long arr[10])
{
 long x[10];
 int8_t i2 = f1 + 1;
 int8_t i = 0;
...
#pragma empty_line
 for(m = 1; m <= 10 -1; m *= 2)
 {
  ...
  {
   sw_merge(x, x+m-1, sw_min(x + 2*m - 1, 10 -1), arr);
   }
 }
}
#pragma empty_line
#pragma empty_line
int main(){
 long arr[10] = {732,41,671,2,567,126,123,8,23,2};
 long sw_arr[10] = {732,41,671,2,567,126,123,8,23,2};
#pragma empty_line
 mergesort(arr);
 sw_mergesort(sw_arr);
#pragma empty_line
