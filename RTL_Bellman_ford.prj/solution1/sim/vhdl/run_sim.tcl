...
if {[file isfile bellman_ford.autotvin.dat]} {
	file delete -force bellman_ford.autotvin.dat
}

if {[file isfile bellman_ford.autotvout.dat]} {
	file delete -force bellman_ford.autotvout.dat
}
