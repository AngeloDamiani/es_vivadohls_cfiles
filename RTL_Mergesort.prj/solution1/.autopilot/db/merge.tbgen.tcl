...
set C_modelArgMapList {[ 
	{ "Name" : "i1", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ i1 sc_in sc_lv 8 signal 0 } 
	{ f1 sc_in sc_lv 64 signal 1 } 
	{ f2 sc_in sc_lv 64 signal 2 } 
	{ arr_address0 sc_out sc_lv 4 signal 3 } 
	{ arr_ce0 sc_out sc_logic 1 signal 3 } 
	{ arr_q0 sc_in sc_lv 64 signal 3 } 
	{ arr_address1 sc_out sc_lv 4 signal 3 } 
	{ arr_ce1 sc_out sc_logic 1 signal 3 } 
	{ arr_we1 sc_out sc_logic 1 signal 3 } 
	{ arr_d1 sc_out sc_lv 64 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "i1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "i1", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9", "Max" : "59"}
	, {"Name" : "Interval", "Min" : "9", "Max" : "59"}
]}
