...
// wrapc file define: "A"
#define AUTOTB_TVIN_A  "../tv/cdatafile/c.floyd_warshall.autotvin_A.dat"
#define AUTOTB_TVOUT_A  "../tv/cdatafile/c.floyd_warshall.autotvout_A.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "A"
#define AUTOTB_TVOUT_PC_A  "../tv/rtldatafile/rtl.floyd_warshall.autotvout_A.dat"
...
extern "C" void floyd_warshall (
int A[10][10]);

extern "C" void AESL_WRAP_floyd_warshall (
int A[10][10])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *A_pc_buffer = new sc_bv<32>[100];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: A
				{
					...
					// {
						// celement: A(31, 0)
						// {
							sc_lv<32>* A_lv0_0_9_1_lv1_0_9_1 = new sc_lv<32>[100];
						// }
					// }
						...
						// celement: A(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 9; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 9; i_1 += 1)
								{
									...
									{
										A_lv0_0_9_1_lv1_0_9_1[hls_map_index].range(31, 0) = sc_bv<32>(A_pc_buffer[hls_map_index].range(31, 0));
										hls_map_index++;
									}
								}
							}
						...
						// celement: A(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 9; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 9; i_1 += 1)
								{
									...
									// output_type_conversion : (A_lv0_0_9_1_lv1_0_9_1[hls_map_index]).to_uint64()
									if (&(A[0][0]) != NULL) // check the null address if the c port is array or others
									{
										A[i_0][i_1] = (A_lv0_0_9_1_lv1_0_9_1[hls_map_index]).to_uint64();
										hls_map_index++;
									}
								}
							}
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* A_tvout_wrapc_buffer = new sc_bv<32>[100];
