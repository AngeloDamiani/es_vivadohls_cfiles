...
$(ObjDir)/floyd_warshall_test.c_pre.c.tb.o : floyd_warshall_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) floyd_warshall_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/floyd_warshall.c_pre.c.tb.o : floyd_warshall.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) floyd_warshall.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
