...
if {[file isfile floyd_warshall.autotvin.dat]} {
	file delete -force floyd_warshall.autotvin.dat
}

if {[file isfile floyd_warshall.autotvout.dat]} {
	file delete -force floyd_warshall.autotvout.dat
}
