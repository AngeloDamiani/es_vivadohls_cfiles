...
#ifndef __bellman_ford_fcmpdEe__HH__
#define __bellman_ford_fcmpdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bellman_ford_fcmpdEe) {
    ...
    SC_CTOR(bellman_ford_fcmpdEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
