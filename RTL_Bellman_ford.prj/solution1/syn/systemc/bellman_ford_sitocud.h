...
#ifndef __bellman_ford_sitocud__HH__
#define __bellman_ford_sitocud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(bellman_ford_sitocud) {
    ...
    SC_CTOR(bellman_ford_sitocud):  ACMP_sitofp_U ("ACMP_sitofp_U") {
