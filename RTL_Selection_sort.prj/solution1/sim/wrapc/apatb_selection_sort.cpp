...
#define AUTOTB_TVIN_arr  "../tv/cdatafile/c.selection_sort.autotvin_arr.dat"
#define AUTOTB_TVOUT_arr  "../tv/cdatafile/c.selection_sort.autotvout_arr.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "arr"
#define AUTOTB_TVOUT_PC_arr  "../tv/rtldatafile/rtl.selection_sort.autotvout_arr.dat"
...
extern "C" void selection_sort (
float arr[10]);

extern "C" void AESL_WRAP_selection_sort (
float arr[10])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *arr_pc_buffer = new sc_bv<32>[10];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: arr
				{
					...
					// {
						// celement: arr(31, 0)
						// {
							sc_lv<32>* arr_lv0_0_9_1 = new sc_lv<32>[10];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: arr(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 9; i_0 += 1)
							{
								...
								{
									arr_lv0_0_9_1[hls_map_index].range(31, 0) = sc_bv<32>(arr_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: arr(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 9; i_0 += 1)
							{
								...
								if (&(arr[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&arr[i_0] = (arr_lv0_0_9_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* arr_tvin_wrapc_buffer = new sc_bv<32>[10];
				...
				// celement: arr(31, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 9; i_0 += 1)
					{
						...
						if (&(arr[0]) != NULL) // check the null address if the c port is array or others
						{
							...
							arr_tvin_wrapc_buffer[hls_map_index].range(31, 0) = arr_tmp_mem.range(31, 0);
                                 	       hls_map_index++;
						}
					}
				}
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* arr_tvout_wrapc_buffer = new sc_bv<32>[10];
				...
				// celement: arr(31, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 9; i_0 += 1)
					{
						...
						if (&(arr[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> arr_tmp_mem;
							arr_tmp_mem = *(int*)&arr[i_0];
							arr_tvout_wrapc_buffer[hls_map_index].range(31, 0) = arr_tmp_mem.range(31, 0);
                                 	       hls_map_index++;
						}
					}
				}
