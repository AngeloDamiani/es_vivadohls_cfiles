...
if {[file isfile banker_algorithm.autotvin.dat]} {
	file delete -force banker_algorithm.autotvin.dat
}

if {[file isfile banker_algorithm.autotvout.dat]} {
	file delete -force banker_algorithm.autotvout.dat
}
